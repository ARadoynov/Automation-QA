...
namespace TestGitHubApi
{
    public class TestGitHubApi
    {
        ...
        public void Setup()
        {            
            client = new GitHubApiClient("https://api.github.com/repos/testnakov/", "ARadoynov", "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");
        ...
        public void Test_CreateGitHubIssue()
        {
            ...
            //Assert
            Assert.That(issue.Id, Is.GreaterThan(0), "There should be comments on the issue");
        ...
        public void Test_CreateCommentOnGitHubIssue()
        {
            //Arrange
            int issueNumber = 1;
            string body = "Body of the new title";

            //Act
            var comment = client.CreateCommentOnGitHubIssue(repo, issueNumber, body);

            //Assert
            Assert.That(comment.Body, Is.EqualTo(body), "There should be comments on the issue");
